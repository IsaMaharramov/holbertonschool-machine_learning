...
def sparse(input_dims, hidden_layers, latent_dims, lambtha):
    ...
    Args:
        ...
        hidden_layers: list containing the number of nodes -> each hidden
                       layer in the encoder, respectively
                       hidden layers should be reversed -> the decoder
        latent_dims: integer containing the dimensions of the latent space
                      representation
        lambtha: regularization parameter used -> L1 regularization on the
                 encoded output
