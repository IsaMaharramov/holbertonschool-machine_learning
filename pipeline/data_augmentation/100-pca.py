...
def pca_color(image, alphas):
    ...
    # Broadcast element-wise multiplication on eigenvectors, then sum across axis 1
    # This exactly mimics [p1, p2, p3] @ [a1*L1, a2*L2, a3*L3]^T
    ...
    # Explicitly cast and return as uint8
    return tf.cast(pca_img, tf.uint8)
