...
class Yolo:
    ...
    def show_boxes(self, image, boxes, box_classes, box_scores, file_name):
        ...
        for box, cls, score in zip(boxes, box_classes, box_scores):
            ...
            # Draw red text 5px above top-left corner
            cv2.putText(
                img,
                label,
                (x1, y1 - 5),
    ...
    def predict(self, folder_path):
        """
        Predicts objects in all images in folder_path, displays them using
        show_boxes, and returns predictions and image paths.
        """
        ...
        for i in range(len(images)):
            ...
            boxes_pred, classes_pred, scores_pred = self.non_max_suppression(
            ...
            self.show_boxes(
                images[i], boxes_pred, classes_pred, scores_pred, file_name
            )

            predictions.append((boxes_pred, classes_pred, scores_pred))
