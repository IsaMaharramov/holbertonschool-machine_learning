...
class NeuralNetwork:
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05,
        ...
        """
        Trains the neural network and visually tracks training data.
        ...
        Args:
            ...
            step (int): The step increment for verbose printing and graphing.
        ...
        # Iterate iterations + 1 times to catch 0th and last states
        for i in range(iterations + 1):
            A1, A2 = self.forward_prop(X)

            # Record data before gradient descent
            ...
            # Perform gradient descent (stop before the extra check iteration)
            if i < iterations:
