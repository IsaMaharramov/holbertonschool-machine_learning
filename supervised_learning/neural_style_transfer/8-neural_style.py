...
class NST:
    ...
    def total_cost(self, generated_image):
        ...
        # VGG requires values 0-255 with ImageNet preprocessing
        ...
        # Content output is the last one
        content_output = outputs[-1]

        # Calculate style and content costs
        J_style = self.style_cost(style_outputs)
        J_content = self.content_cost(content_output)

        # Calculate the total cost J
    ...
    def compute_grads(self, generated_image):
        ...
        Args:
            generated_image: a tf.Tensor or tf.Variable of shape (1, nh, nw, 3)
